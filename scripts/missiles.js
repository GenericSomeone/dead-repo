...
//defense_rocket.trailEffect = Fx.fireSmoke;
...
rocket_pod.width = 8;
rocket_pod.height = 8;
//rocket_pod.trailEffect = Fx.fireSmoke;
rocket_pod.keepVelocity = true;
rocket_pod.trailChance = 0.5;
//rocket_pod.trailColor = Color.valueOf("40b2fb")
...
splinter.width = 4;
splinter.height = 16;
//splinter.trailEffect = Fx.fireSmoke;
...
//rocket_pod_ap.trailEffect = Fx.fireSmoke;
